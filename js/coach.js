...
// ==================== 🎖️ نظام الأوسمة والإنجازات (BADGES SYSTEM) ====================

const BADGES_CONFIG = [
    // --- 🏃‍♂️ أوسمة المسافات (Milestones) ---
    { id: 'dist_50k', name: 'بداية الطريق', icon: '🥉', desc: 'أتممت 50 كم إجمالي' },
    { id: 'dist_100k', name: 'المئوية الأولى', icon: '🥈', desc: 'أتممت 100 كم إجمالي' },
    { id: 'dist_500k', name: 'نصف مليون خطوة', icon: '🥇', desc: 'أتممت 500 كم إجمالي' },
    { id: 'dist_1000k', name: 'أسطورة الكيلومترات', icon: '👑', desc: 'كسرت حاجز 1000 كم!' },
    ...
    { id: 'speed_turbo', name: 'تيربو', icon: '🏎️', desc: 'بيس أقل من 6:00 د/كم' },

    // --- 🔥 أوسمة الالتزام (Consistency) ---
    { id: 'streak_7', name: 'أسبوع ناري', icon: '🔥', desc: 'تمرين لمدة 7 أيام متتالية' },
    { id: 'streak_30', name: 'وحش الالتزام', icon: '📆', desc: 'تمرين لمدة 30 يوم متتالية' },
    { id: 'early_bird', name: 'طائر الصباح', icon: '🌅', desc: 'تمرين قبل الساعة 7 صباحاً' },
    { id: 'night_owl', name: 'ساهر الليل', icon: '🦉', desc: 'تمرين بعد الساعة 10 مساءً' },

    // --- 🤝 أوسمة الفريق (Community) ---
    { id: 'social_star', name: 'نجم الفريق', icon: '🌟', desc: 'عضو نشط ومؤثر' },
    { id: 'challenger', name: 'المنافس', icon: '⚔️', desc: 'شارك في 5 تحديات' },
    { id: 'supporter', name: 'الداعم', icon: '💖', desc: 'شجع زملاءه باستمرار' },
    { id: 'weekend_warrior', name: 'محارب العطلة', icon: '🌴', desc: 'تمرين قوي يوم الجمعة أو السبت' },
];
